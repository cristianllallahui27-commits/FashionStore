...
namespace FashionStore.Infrastructure.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(FashionStoreDbContext context)
        {
            ...
            Prendas = new GenericRepository<Prenda>(_context);
            ...
            DetalleVentas = new GenericRepository<DetalleVenta>(_context);
            MetodosPago = new GenericRepository<MetodoPago>(_context);
            Configuraciones = new GenericRepository<ConfiguracionSistema>(_context);
            ConfiguracionesAuditoria = new GenericRepository<ConfiguracionAuditoria>(_context);
            DescuentosAutorizados = new GenericRepository<DescuentoAutorizado>(_context);
        }
